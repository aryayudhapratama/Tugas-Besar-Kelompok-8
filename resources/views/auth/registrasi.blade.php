            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="img-thumbnail d-block w-100" src="{{ Vite::asset('resources/images/gb1.png') }}"
                            alt="image">
                    </div>
                    <div class="carousel-item active">
                        <img class="img-thumbnail d-block w-100" src="{{ Vite::asset('resources/images/gb2.png') }}"
                            alt="image">
                    </div>
                    <div class="carousel-item h-100">
                        <img class="img-thumbnail d-block w-100" src="{{ Vite::asset('resources/images/gb3.png') }}"
                            alt="image">
                    </div>
                </div>
