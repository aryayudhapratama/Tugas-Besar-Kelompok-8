                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('products.create') }}" class="btn text-white" style="background-color:#f4623a">Create New Data</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <td>{{ $product->price }}</td>
                                            <td>{{ $product->stock }}</td>
                                            <td><img src="{{ asset('storage/product-picture/'.$product->picture) }}" alt="" width="100"></td>
